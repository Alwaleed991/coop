...
<template>
  <AppLayout>
    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
      <h2 class="text-xl font-semibold mb-2">Welcome to the awesome posts page</h2>
      <p class="text-gray-600">Here you can see all posts and you can click on a post to reports or comment on it</p>
    </div>
